...
namespace DTORepository.Common
{
    ...
    public interface ISuccessOrErrors<T> : ISuccessOrErrors
    {
        ...
        /// <param name="errors"></param>
        /// <returns></returns>
        new ISuccessOrErrors<T> SetErrors(IEnumerable<string> errors);
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        new ISuccessOrErrors<T> AddSingleError(string errorformat, params object[] args);
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        new ISuccessOrErrors<T> AddNamedParameterError(string parameterName, string errorformat, params object[] args);
        ...
        /// <param name="status"></param>
        /// <returns></returns>
        new ISuccessOrErrors<T> Combine(object status);
